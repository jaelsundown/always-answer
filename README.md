## Always Answer Front-End Service
Built using Gatsby, React, GraphQL, Wordpress GraphQL Plugins, Jest, and nodeJS in order to create the front-end server that will compile and be deployable as a static website for the company Always Answer. This will serve as a repository of blog and articles stored to their Wordpress installation as well as a presentation layer for their shareholders to use to interact with the company and facilitate education and engagement within the community.
...
<--- Deployment process to be designed at a later date. --->
